...
public:
    ...
    FragmentIon(string ionType, int position, int loss, double mz, unsigned int ch, unsigned int prom,
                unsigned int isotope = 0, double mzDiff = 0.0, bool bracket = false);
