...
enum eWhatToRead {
    RAMP_RUNINFO, RAMP_HEADER, RAMP_PEAKS, RAMP_INSTRUMENT
};
...
public:
    ...
    //
    rampScanInfo(RAMPFILE *m_handle, ramp_fileoffset_t index,
                 int seqNum); // populate from file at this position, assign this sequence number
